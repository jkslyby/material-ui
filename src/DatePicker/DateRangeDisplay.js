...
class DateRangeDisplay extends Component {
  static propTypes = {
    ...
    disableYearSelection: PropTypes.func,
    ...
    return (
      <div {...other} style={prepareStyles(styles.root, style)}>
        ...
        <div style={styles.monthDay}>
          <div key={`start-${startDate}`} style={{position: 'unset', width: '100%', top: 'unset', left: 'unset'}}>
          ...
          <div key={`end-${endDate}`} style={{position: 'unset', width: '100%', top: 'unset', left: 'unset'}}>
